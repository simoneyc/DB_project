...
def insert_tool(t_name, col_list, value_str): 
    # t_name: 'movieinfo', col_list: ['title', 'genre', 'duration', 'releasetime']
    # , value_str: "('1111111','drama','0h 0m','')"
    global query_list                           
    sql_DB = """INSERT INTO `%s` (%s) VALUES %s"""
    # column name
    ins_col_str = "%s" % ", ".join(col_list) 
    # ins_col_str: 'title, genre, duration, releasetime'

    # sql
    # sql_DB: "INSERT INTO `movieinfo` (title, genre, duration, releasetime) VALUES ('1111111','drama','0h 0m','')"
